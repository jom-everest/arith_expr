...
#include <stdio.h>
  ...
  const char HUNDR_cl::oper_sym[] = {'+', '-', '*', '/', '&'};

//--------------------------------------
char* HUNDR_cl::expr(char* sss)
{
	char ch;
	char left, right;
...
//------------------------------------------------------
inline void HUNDR_cl::double_fa_v1()
{
register float a, b;
...
//---------------------------------------
inline void HUNDR_cl::double_fa_v2()
{
register double a, b;
