...
//-------------------------------------------
inline int HUNDR_v::compose(const char* digits, int v)
{
...
//-------------------------------------------
inline int HUNDR_v::compose(long n, int t, str30* list)
{
  if (n < 1) return 0;
...
//-------------------------------------------
inline void HUNDR_v::SA(const char* str)
{
	++map[str];
}
